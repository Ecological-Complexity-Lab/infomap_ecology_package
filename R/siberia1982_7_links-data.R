#' Host-parasite temporal multilayer network: links
#'
#' This data set contains the links of a temporal multilayer
...
#'
#'  See \code{siberia1982_7_nodes} for information about the nodes.
#'
#' @docType data
#'
#' @usage data(siberia1982_7_links)
...
#'
#'
#' @seealso \code{siberia1982_7_nodes}
#'
#' @examples
