...
#'
#'We use Infomap as a stand-alone file. Future versions will integrate Infomap
#'directly into R. Complete instructions on how to download, install and use
#'Infomap can be found in
...
#'same working folder in which the R code is run. See details in \href{https://ecological-complexity-lab.github.io/infomap_ecology_package/installation}{https://ecological-complexity-lab.github.io/infomap_ecology_package/installation}
#'
...
#'@author Shai Pilosof
#'
#'@references Farage C, Edler D, Eklöf A, Rosvall M, Pilosof S. Identifying flow
#'  modules in ecological networks using Infomap. Methods in Ecology and
#'  Evolution 2021. doi:10.1111/2041‐210X.13569
#'  
NULL
