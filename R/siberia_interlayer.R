...
#'   
#'   See \code{siberia1982_matrix} Siberia 1982 host-parasite temporal matrix.
#'
#' @format Edge list format (layer_from node_from layer_to node_to weight).
#'
#' @source Simulated data for illustration purposes.
#'
#' @docType data
#'
#' @usage data(siberia_interlayer)
#' 
...
siberia_interlayer <- matrix(c(1, 0, 1, 0, 0, 1, 1, 1, 0, 1, 0, 0), nrow = 3, ncol = 4)
